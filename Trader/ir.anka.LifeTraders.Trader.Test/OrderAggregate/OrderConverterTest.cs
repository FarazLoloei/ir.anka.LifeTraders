...
public class OrderConverterTest : OrderTestProvider
{
    ...
    public async Task OrderToOrderDTOConverterTest(Guid accountId,
                                                   string login,
                                                   long ticket,
                                                   string symbol,
                                                   double openPrice,
    ...
    {
        var order = new Order(accountId, login, ticket, symbol, openPrice, openDateTime, closePrice, closeDateTime, closeVolume, stopLoss, takeProfit,
